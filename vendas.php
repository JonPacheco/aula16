...
<form method="POST">
idVendedor <input type="text" name="idvendedor"  value="<?php echo isset($cliente) ? $cliente->idvendedor : null ?>"><br>

idProduto <input type="text" name="idproduto"       value="<?php echo isset($cliente) ? $cliente->idproduto : null ?>"><br>

Quantidade <input type="text" name="qtd"       value="<?php echo isset($cliente) ? $cliente->qtd : null ?>"><br>

<input type="hidden"     name="idvendas"   value="<?php echo isset($cliente) ? $cliente->idvendas : null ?>">
