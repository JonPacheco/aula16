...
<form method="POST">
Produto  <input type="text" name="produto"  value="<?php echo isset($cliente) ? $cliente->produto : null ?>"><br>

Preço <input type="text" name="preco"       value="<?php echo isset($cliente) ? $cliente->preco : null ?>"><br>

Estoque<input type="text" name="estoque"       value="<?php echo isset($cliente) ? $cliente->estoque : null ?>"><br>

<input type="hidden"     name="idproduto"   value="<?php echo isset($cliente) ? $cliente->idproduto : null ?>">
